  ...
  @endif
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="{{ $core->url('/') }}">{{ $core->getTitle() }}</a>
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="{{ $core->url('/model/AdminxLog?filter_user=' . auth()->id()) }}">{{ $core->getWord('user.btn.log', 'Activity History') }}</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ $core->getLogout() }}">{{ $core->getWord('logout.btn', 'Logout') }}</a>
                    </div>
                </li>
            </ul>
        </nav>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <a id="dashborad-item" class="nav-link" href="{{ $core->url('/') }}">
                                ...
                                {{ $core->getWord('menu.dashboard', 'Dashboard') }}
                            </a>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">{{ $core->getCopyright() }}</div>
                            <div>
